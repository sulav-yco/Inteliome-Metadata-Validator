...
from pyvalidator.schema_validator import SchemaWrapper, GeneratedSchema, TableInfo, Column
...
class DDLValidator():
    ...
    def types_are_equivalent(self,ddl_type: str, schema_type: str) -> bool:
        ...
        for equivalents in TYPE_EQUIVALENTS.values():
    ...
    def validate_schema(self, generated_schema: Dict):
        ...
        print(schema.columns.values())
        print(schema_columns)
        print(list(schema_columns.keys()))
